...
public class Main extends Application {
	...
	Label lbl = new Label("0");   //Textfelder
	Label lbldialog = new Label("Geben sie die maximale Zahl des Zugfallsgeneratoren ein(Bitte geben sie nur Integer ein)");
		...
		buttondialog.setOnAction(new EventHandler<ActionEvent>() {
		    @Override public void handle(ActionEvent e) {
		    	try
		    	{
		    		switch(zahlenart)
		    		{
		    			case 1 : int n = Integer.parseInt(feld.getText());lbl.setText("" + generator.nextInt(n));
		    			break;
		    			case 2 : double ndouble = Double.parseDouble(feld.getText());lbl.setText("" + generator.nextDouble() * ndouble);
		    			break;
		    			case 3 : long nlong = Long.parseLong(feld.getText());lbl.setText("" + generator.nextLong(nlong));
		    			break;
		    		}
	...
	void makeUI()
	{
		...
		dialogPane.getChildren().addAll(radiobuttondouble,radiobuttonint,radiobuttonlong,feld,lbldialog,buttondialog);
		...
		buttonboxes.getChildren().addAll(vertikaleButtonBox4,vertikaleButtonBox3,vertikaleButtonBox2,vertikaleButtonBox);
		AnchorPane.setBottomAnchor(buttonboxes, 5.0);
		AnchorPane.setRightAnchor(buttonboxes, 5.0);
		setCSSStyle("buttonStyle2",buttonPI,buttonAC,buttongeteilt,buttonmal,buttonminus,buttonplus,buttongleich,buttonrandom);
